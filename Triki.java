...
/**
 * Write a description of class Triki here.
 *
 * @author (your name)
...
public class Triki extends JFrame
{
    ...
    {
        marco.setTitle("Triki Traki");
        ImageIcon icono = new ImageIcon(getClass().getResource("/TrikiTraki.png"));
        ...
        scoreBoard.add(score = new JLabel(""));
        scoreBoard.add(score2 = new JLabel(""));
        score.setBorder(BorderFactory.createLineBorder(Color.GREEN));
        score2.setBorder(BorderFactory.createLineBorder(Color.RED));
    ...
    public void l1MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[0] == "n"){
            if (X == O)
            {
                l1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[0] = "X";
                X++;
            }
            else if (X > O)
            {
                l1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[0] = "O";
                O++;
            }
    ...
    public void l2MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[1] == "n"){
            if (X == O)
            {
                l2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[1] = "X";
                X++;
            }
            else if (X > O)
            {
                l2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[1] = "O";
                O++;
            }
            traki.verificarJuego();
    ...
    public void l3MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[2] == "n"){
            if (X == O)
            {
                l3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[2] = "X";
                X++;
            }
            else if (X > O)
            {
                l3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[2] = "O";
                O++;
            }
            traki.verificarJuego();
    ...
    public void l4MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[3] == "n"){
            ...
            {
                X++;
                l4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[3] = "X";
            }
            else if (X > O)
            {
                O++;
                l4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[3] = "O";
            }
            traki.verificarJuego();
        }
    ...
    public void l5MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[4] == "n"){
            if (X == O)
            {
                l5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[4] = "X";
                X++;
            }
            else if (X > O)
            {
                l5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[4] = "O";
                O++;
            }
            traki.verificarJuego();
    ...
    public void l6MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[5] == "n"){
            if (X == O)
            {
                l6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[5] = "X";
                X++;
            }
            else if (X > O)
            {
                l6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[5] = "O";
                O++;
            }
            traki.verificarJuego();
    ...
    public void l7MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[6] == "n"){
            if (X == O)
            {
                l7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[6] = "X";
                X++;
            }
            else if (X > O)
            {
                l7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[6] = "O";
                O++;
            }
            traki.verificarJuego();
    ...
    public void l8MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[7] == "n"){
            if (X == O)
            {
                l8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[7] = "X";
                X++;
            }
            else if (X > O)
            {
                l8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[7] = "O";
                O++;
            }
            traki.verificarJuego();
    ...
    public void l9MouseClicked(MouseEvent evt)
    {
        if(traki.getGame()[8] == "n"){
            if (X == O)
            {
                l9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/X.png")));
                traki.getGame()[8] = "X";
                X++;
            }
            else if (X > O)
            {
                l9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/O.png")));
                traki.getGame()[8] = "O";
                O++;
            }
            traki.verificarJuego();
